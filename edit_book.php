...
?>
  <div class="container">
    <div class="col-sd-4 col-sm-12 align-self-center" id=form>
      <center> <b class="hdng">Edit Book Information</b></center>
      <form action="edit_book.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <img src="<?php echo($book['Book_Cover'])?>" height="250px", width=auto></br>
        ...
        <a href="book_detail.php?id=<?php echo($id) ?>"><input type="button" class="btn btn-secondary" value="Cancel"></a>
      </form>
    </div>
  </div>
